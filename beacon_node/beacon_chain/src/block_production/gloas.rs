...
impl<T: BeaconChainTypes> BlockProducer<T> {
    ...
    pub async fn produce_block_on_state_gloas(
        ...
        let (partial_beacon_block, state) = self
            ...
            .spawn_blocking_handle(
                move || {
                    self_clone.produce_partial_beacon_block_gloas(
                        state,
                        state_root_opt,
                        produce_at_slot,
                        randao_reveal,
        ...
        self.task_executor
            .spawn_blocking_handle(
                move || {
                    self_clone.complete_partial_beacon_block_gloas(
    ...
    > {
        ...
        let prepare_payload_handle =
            self.get_execution_payload_gloas(&state, parent_root, proposer_index, builder_params)?;
    ...
    fn get_execution_payload_gloas(
        self: &Arc<Self>,
        state: &BeaconState<T::EthSpec>,
        ...
        let join_handle = self
            ...
            .spawn_handle(
                async move {
                    self_clone
                        .prepare_execution_payload_gloas(
                            timestamp,
                            random,
                            proposer_index,
    ...
    /// after the Gloas fork.
    #[allow(clippy::too_many_arguments)]
    async fn prepare_execution_payload_gloas(
        self: Arc<Self>,
        timestamp: u64,
        random: Hash256,
        proposer_index: u64,
