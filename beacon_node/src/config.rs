...
pub fn get_config<E: EthSpec>(
    ...
    let execution_endpoint_and_secret_file_opt = if let Some(endpoints) = endpoints {
    ...
    if let Some((execution_endpoint, secret_file)) = execution_endpoint_and_secret_file_opt {
