use super::{EthSpec, Slot, SyncAggregate};
use crate::{
    light_client_update::Error, test_utils::TestRandom, BeaconState, ChainSpec, ForkName,
    ForkVersionDeserialize, LightClientHeader, SignedBeaconBlock,
};
